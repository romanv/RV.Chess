...
namespace RV.Chess.Board.Utils
{
    public static class Zobrist
    {
        ...
        internal static ulong GetIncrementalHash(Chessgame game)
        {
            ulong hash = 0;
        ...
        internal static ulong GetCastlingHash(Chessgame game)
        {
            ulong hash = 0;
        ...
        internal static ulong GetPieceHash(int square, PieceType type, Side side)
        {
            var index = ((int)type - 1) * 2 + (int)side;
            return Pieces[64 * index + square];
        }

        internal static ulong GetEnPassantHash(ulong epSquareMask)
        {
        ...
        internal static readonly ulong[] Pieces = new ulong[]
        {
        ...
        internal static readonly ulong WhiteTurn = 0xF8D626AAAF278509;

        internal static readonly ulong[] EnPassant = new ulong[]
        {
            0x70CC73D90BC26E24,
            0xE21A6B35DF0C3AD7,
            0x003A93D8B2806962,
